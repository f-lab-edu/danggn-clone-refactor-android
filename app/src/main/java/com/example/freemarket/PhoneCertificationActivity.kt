...
class PhoneCertificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 백버튼
        ibtPhoneCertificationBack.setOnClickListener(
        ...
        // 인증번호 get 하는 버튼
        btPhoneCertificationGetNumber.setOnClickListener(
            View.OnClickListener {
        ...
        // 인증번호 확인
        btPhoneCertificationNumberOk.setOnClickListener(
            View.OnClickListener {
        ...
        // 인증번호 다시 받기
        btPhoneCertificationGetReNumber.setOnClickListener(
            View.OnClickListener {
                Toast
                    .makeText(this@PhoneCertificationActivity, "인증번호를 전송했습니다", Toast.LENGTH_SHORT)
                    .show()
                resetTimer()
            },
        )

        etPhoneCertificationPhoneNumber.addTextChangedListener(
            object : TextWatcher {
